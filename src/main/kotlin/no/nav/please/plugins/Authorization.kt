...
//
//fun Application.configureAuthorization(getMachineToMachineToken: MachineToMachineToken, getRefreshedMachineToMachineToken: RefreshMachineToMachineToken): navEmployeeIsAuthorized {
//
//
//
//
